 ...
 * That still drives `inspectionJson`'s throw (the throw happens
 * BEFORE the api.js catch runs). The assertion below is "no
 * user-visible crash", which is what the user-data swallow produces
 * in practice.
 */
