 ...
 * key for exactly this purpose: write a JSON array there before the
 * dashboard mounts and `getAllGroups` returns it verbatim. The key
 * follows the same pattern as the existing `MOCK_LOGIN_FAIL` /
